...
2. **Autenticação em Subrecursos Cross-Origin ([deps.py](file:///Users/laurielmesquita/Space%20Square/02-Customers/TalentFlow/05-Projetos/talentflow-api/app/api/deps.py)):**
...
2. **Visualizador Resiliente ([PDFViewer.tsx](file:///Users/laurielmesquita/Space%20Square/02-Customers/TalentFlow/05-Projetos/talentflow-web/src/components/PDFViewer.tsx)):**
   - Consome a rota proxy da API com injeção do token JWT do cliente (`?token=${authToken}`).
3. **Sintaxe CSS em Globals ([globals.css](file:///Users/laurielmesquita/Space%20Square/02-Customers/TalentFlow/05-Projetos/talentflow-web/src/app/globals.css)):**
