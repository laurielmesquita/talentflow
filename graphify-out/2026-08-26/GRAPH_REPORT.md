...
## Corpus Check
- 177 files · ~152,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1163 nodes · 1855 edges · 112 communities (95 shown, 17 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4d29346`
...
Cohesion: 0.07
Nodes (46): Candidate, extract_resume_sandbox(), BaseModel, Request, UploadFile, SandboxExperience, SandboxResponse, CandidateExtraction (+38 more)

### Community 1 - "ScopedSession"
Cohesion: 0.21
Nodes (23): Base, FlagRequest, BaseModel, ReplaceRequest, JobUpdate, match_candidates(), update_job(), OTPVerifyRequest (+15 more)

### Community 2 - "apiFetch"
Cohesion: 0.18
Nodes (14): LoginContent(), emptyForm, ManagedUser, UserRole, UsersPage(), UserMenu(), AuthSession, clearSession() (+6 more)
...
Cohesion: 0.13
Nodes (27): delete_candidate(), extract_cloudinary_public_id(), flag_candidate(), get_candidate_pdf(), get_cloudinary_pdf_bytes(), process_batch_uploads_task(), process_single_file(), BackgroundTasks (+19 more)
...
### Community 7 - "deps.py"
Cohesion: 0.13
Nodes (16): create_customer_portal_session(), Cria uma sessão no portal do cliente (para gerenciar assinaturas, ver faturas, e, get_current_user(), Request, Factory de dependência FastAPI que verifica se o tenant do usuário logado tem ac, Dependency to validate the JWT access token and return the authenticated user., Dependency class to restrict access based on user roles., require_feature() (+8 more)
...
Cohesion: 0.13
Nodes (30): Response, change_password(), forgot_password(), login(), logout(), Request, Session, Redefine a senha do usuário com base no token recebido por e-mail. (+22 more)
...
Cohesion: 0.16
Nodes (11): CandidatesPage(), metadata, CandidateTable(), DeleteConfirmModalProps, getCandidates(), getCategories(), Candidate, CandidatesResponse (+3 more)

### Community 17 - "Job"
Cohesion: 0.20
Nodes (8): getJobDetail(), JobDetailPage(), PageProps, DashboardClientProps, JobCardProps, JobFormDrawerProps, Job, JobFormData
...
Cohesion: 0.12
Nodes (20): get_batch_job_status(), get_candidate_versions(), Consulta o estado de processamento de um lote de upload.     Retorna percentual, CategoryCreate, CategoryUpdate, create_category(), delete_category(), list_categories() (+12 more)
...
Cohesion: 0.14
Nodes (13): [0.1.0] — 2026-06-16, [0.4.0] — 2026-06-19, [0.7.0] — 2026-06-21, [0.9.0] — 2026-06-21, [1.0.0] — 2026-06-21, Adicionado, Adicionado, Adicionado (+5 more)

### Community 22 - "sandbox.py"
Cohesion: 0.07
Nodes (36): datetime, get_db(), Dependency to get a SQLAlchemy database session., get_public_job(), list_public_jobs(), Session, Retorna a listagem de todas as vagas ativas no portal público.     Não exige aut, Retorna os detalhes de uma vaga pública específica identificada pelo slug semânt (+28 more)
...
Cohesion: 0.13
Nodes (20): get_dashboard_stats(), create_job(), delete_job(), get_job(), JobCreate, list_jobs(), BaseModel, _serialize_job() (+12 more)
...
Cohesion: 0.19
Nodes (12): BatchUploadButtonProps, UploadStatus, CategoriesDashboard(), Category, JobDetailView(), JobFormDrawer(), JobsListDashboard(), PageHeaderProps (+4 more)
...
Cohesion: 0.06
Nodes (28): Contexto, Decisão de rollout, Implementação registrada, Incidentes e correções, Próximos passos, Registro de mudança — Migração da API para Render Free, Validação realizada, Configuração (+20 more)
...
Cohesion: 0.23
Nodes (20): _active_manager_count(), create_user(), deactivate_user(), _get_user_or_404(), _protect_last_manager(), _protect_owner(), _protect_super_admin_grant(), UUID (+12 more)
...
- **Why does `User` connect `services/auth.py` to `ScopedSession`, `resolve_job_id`, `design-switcher.tsx`, `deps.py`, `api/auth.py`, `ConflictModal.tsx`, `shine-border.tsx`, `preset-provider.tsx`, `migrate_db_data.py`?**
