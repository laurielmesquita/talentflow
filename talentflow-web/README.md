...
- **`src/app/settings/`**: Central de configurações da conta, com edição do nome, telefone, e-mail confirmado, preferências persistidas e exportação individual de dados.
