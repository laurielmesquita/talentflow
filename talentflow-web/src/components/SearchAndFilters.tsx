          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium border transition-all duration-200 ${
              showAdvanced || activeCategory
               ...
               : 'glass-panel bg-background/30 border-border/70 hover:bg-accent/50 text-foreground'
            }`}
          >
          ...
          {hasActiveFilters && (
            <button
              onClick={handleClearFilters}
               className="flex items-center gap-1.5 px-4 py-2.5 glass-panel bg-background/30 hover:bg-destructive/10 border-border/70 rounded-xl text-sm font-medium text-destructive transition-colors"
            >
              Limpar Tudo
            </button>
          )}
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all duration-200 ${
                      isActive
                        ? 'bg-primary border-primary/50 text-primary-foreground shadow-md'
                         : 'bg-background/35 border-border/70 text-muted-foreground hover:border-primary/35 hover:text-foreground'
                    }`}
                  >
                    {cat.name}
                  </button>
